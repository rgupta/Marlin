...
#define STRING_CONFIG_H_AUTHOR "(Rahul Gupta, Tevo Tarantula)" // Who made the changes.
...
#define MACHINE_UUID "9e03bd74-d116-4b8a-a2bc-8db0b260cf3a"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // tune to 200 degreesC for 20 cycles
  // M303 E0 C20 S200 U
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // tune to 60 degreesC for 20 cycles
  // M303 E-1 C20 S60 U
  #define DEFAULT_bedKp 233.32
  #define DEFAULT_bedKi  42.18
  #define DEFAULT_bedKd 860.41
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 25, 125 }
